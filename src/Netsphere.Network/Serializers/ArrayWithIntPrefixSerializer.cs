...
{
    /// <summary>
    /// Serializes an array with a int32 length prefix
    /// </summary>
    public class ArrayWithIntPrefixSerializer : ISerializerCompiler
    {
        ...
        public void EmitSerialize(CompilerContext context, Local value)
        {
            ...
            using (var length = context.Emit.DeclareLocal<int>("length"))
            {
                ...
                context.Emit.Call(ReflectionHelper.GetMethod((BinaryWriter _) => _.Write(default(int))));
        ...
        public void EmitDeserialize(CompilerContext context, Local value)
        {
            ...
            using (var length = context.Emit.DeclareLocal<int>("length"))
            {
                ...
                context.Emit.LoadReaderOrWriterParam();
                context.Emit.Call(ReflectionHelper.GetMethod((BinaryReader _) => _.ReadInt32()));
                context.Emit.StoreLocal(length);
